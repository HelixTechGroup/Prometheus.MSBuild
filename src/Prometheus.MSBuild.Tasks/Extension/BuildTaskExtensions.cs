...
namespace Prometheus.MSBuild.Tasks.Extension
{
    ...
    {
        public static IList<ProjectPropertyInstance> GetProperties(this BuildUtil.Task task, ProjectInstance instance, PropertySearchSettings options)
        {
        ...
        public static void AddImports(this BuildUtil.Task task, IEnumerable<ITaskItem> filesToImport, ref ProjectInstance instance)
        {
            try
            {
                ...
                {
                    task.Log.LogMessage(MessageImportance.High, $"| >>>> Importing File: {f}");
